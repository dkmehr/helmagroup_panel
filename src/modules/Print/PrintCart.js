...
function PrintCart(props) {
  ...
  const faktorItems = orderInfo ? orderInfo.data.items : "";
  const total = orderInfo ? orderInfo.calcFaktor : "";
  const userInfo = orderInfo ? orderInfo.userDetail : "";
  // const manInfo = orderInfo?orderInfo.manData[0]:''
  return (
    <div className="printArea">
      <div className="userInfo">
        <div className="hesabfaSection"></div>
        ...
        <div className="hesabfaSection" style={{ minWidth: "240px" }}>
          ...
          <small>
            ...
            <b>
              {new Date(
                orderInfo && orderInfo.data.progressDate
      ...
      <table className="hesabfaTable">
        <tbody>
          <tr>
            <td
              className="verticalRow hesabfaColor "
        ...
        <div className="footerRows">
          <div className="hesabfaPrice">
            {/* <div className="priceSeprate">
              <span>مجموع:</span>
              <span>{normalPriceRound(orderInfo.data.totalPrice)} ریال</span>
            </div>
            <div className="priceSeprate">
              <span>تخفیف:</span>
            ...
            <hr />
            <h3>مبلغ کل: {normalPriceRound(orderInfo.data.totalPrice)} ریال</h3>
            <strong> </strong>
          </div>
          <div className="hesabfaPrice">
            <div className="priceSeprate">
              <span>توضیحات:</span>
              <span>{orderInfo.data.description}</span>
            </div>
            {/* <div className="sharePart">
              <button
                type="button"
                className="print-btn-crm"
